...
1. 在首页用户信息面板点击 **Upgrade Premium**
2. 在弹窗中点击 **Purchase Premium** 按钮
3. 浏览器将打开支付页面，完成支付
4. 支付成功后查收邮件，获取 Payment ID

#### 方式二：激活凭证

1. 在首页点击 **核销凭证** 入口
2. 输入您获得的 Payment ID（格式：`pay_xxxxxx`）
3. 点击 **激活** 按钮
4. 激活成功后即刻享受 Premium 权益

> 🔒 安全提示：每个 Payment ID 仅可使用一次且不可共享，请妥善保管
